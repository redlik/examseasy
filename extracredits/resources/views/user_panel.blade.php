...
<div class="col bg-white rounded shadow-sm p-4">
    <div class="row">
        <div class="col-3 text-center d-none d-md-block">
            <img src="{{ asset('images/avatar.svg') }}" alt="User Profile image" class="img-fluid" width="200px" height="200px">
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route('lesson_canonical_view', [$lesson->subject->name, $lesson->topic->subcategory->slug, $lesson->topic->slug, $lesson->slug]) }}"
                    class="text-success mr-2" title="View lesson"><i class="far fa-eye"></i> View lesson</a></td>
              </tr>
              @endforeach
            </tbody>
        </table>
