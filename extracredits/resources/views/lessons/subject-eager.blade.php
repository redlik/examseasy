...
<div class="container bg-white rounded-lg shadow p-3">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="text-uppercase font-weight-black">{{ ucfirst($subject->full_name) }} lessons eager</h1>
    ...
    <div class="row">
        <div class="col-12 col-md-9 mx-auto">
            ...
            @else
            @foreach ($subject->categories as $subcategory)

            <div
                class="d-flex justify-content-between align-items-center bg-light rounded shaddow-sm mt-2 w-100 position-relative">
                <h5 class="font-weight-bold text-uppercase p-2">{{ $subcategory->name }} -
                    No {{ $subject->lesson_count }} lessons</h5>
